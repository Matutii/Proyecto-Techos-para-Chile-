...
import { RegistroHoras } from '../entities/registroHoras.entity.mjs';
...
export const AppDataSource = new DataSource({
    ...
    synchronize: true,
    logging: false,
    entities: [Usuario, Proyecto, Material, HistorialStock, Voluntario, Donacion, Cuadrilla, CuadrillaVoluntario, RegistroHoras],
});

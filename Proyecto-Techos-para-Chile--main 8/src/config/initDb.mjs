...
export async function createInitialUsers() {
    ...
    const hash = await bcrypt.hash('180420', 10);
    ...
    await repo.save([
        ...
        {
            nombre: 'Colaborador Terreno',
            email: 'colaborador@techos.cl',
            passwordHash: hash,
            rol: 'colaborador',
        },
        {
            nombre: 'Encargado de Cuadrillas',
            email: 'cuadrillas@techos.cl',
            passwordHash: hash,
            rol: 'encargado_cuadrillas',
        },
        {
            nombre: 'Visitante Demo',
            email: 'visitante@techos.cl',
            passwordHash: hash,
            rol: 'visitante',
        },
    ]);
